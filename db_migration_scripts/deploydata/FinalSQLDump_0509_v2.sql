...
INSERT INTO
  `addresses`
VALUES
  (3, '80275', '802', 'address address address', NULL),
(
    4,
    '20775',
    '803',
...
VALUES
  (1, 'Ski packages', NULL),
(2, 'Ski/board & bindings (own boots)', NULL),
(3, 'Ski/Snowboard boots only', NULL),
(4, 'Snowboard package', NULL);
...
VALUES
  (
    1,
    '11EA64D91C6E8F70A23EB6800B5BCB6D',
    '3a62ea5aa2d8845a72dd030369dd571d5123567f70fa76b5bc3bcdf103e3307cc52b01030230c4f2807b44f88ce0052e91f3b7550341f38fe6544d02abfd7d87',
    'Squizzunimelb!0',
    'PJSAS',
    '11EAF2251136B090BB69B6800B5BCB6D'
  ),
(2, 'unimelb', NULL, NULL, NULL, NULL),
...
(
    ...
    1,
    2,
    'Beginner Package - Child 6 - 14 yrs',
    'description2'
  ),
(
    3,
    ...
    1,
    1,
    'Beginner Package - Child Under 6 yrs',
    'description3'
  ),
(4, 1, 2, 4, 'Intermediate Package', 'description4'),
(5, 1, 3, 4, 'Performance Package', 'description5'),
(6, 2, 1, 3, 'Beginner - Adult', 'description6'),
(
    7,
    2,
    1,
    2,
    'Beginner - Child 6 -14yrs',
    'description7'
  ),
(8, 2, 1, 1, 'Beginner - Child U6', 'description8'),
(9, 2, 2, 4, 'Intermediate Ski Only', 'description9'),
(10, 2, 3, 4, 'Performance Ski Only', 'description10'),
(11, 3, 1, 3, 'Beginner - Adult', 'description11'),
(
    12,
    3,
    1,
...
(
    ...
    1,
    1,
    'Beginner - Child Under 6yrs',
    'description13'
  ),
(14, 3, 2, 4, 'Intermediate Boot', 'description14'),
(
    15,
    3,
    3,
    4,
    'Back Country Touring Boot',
    'description15'
  ),
(
    16,
...
VALUES
  (1, 'helmet', 'something'),
(2, 'pole', 'something'),
(12, 'walkingboots', 'something'),
(13, 'jacket', 'something'),
(14, 'pants', 'something'),
(15, 'skiboard', 'something'),
(16, 'glove', 'something');
...
(
    ...
    0.00,
    1,
    '{\"size\":\"S\", \"brand\":\"fox\", \"width\":\"52\", \"skill_level\":\"DH\" }',
    16
  ),
(4, 'Accelerator', 0, 'something', 30.00, 1, '{}', 15),
(5, 'poleQ1', 1, 'something', 40.00, 1, '{}', 2),
(6, 'poleQ2', 1, 'something', 50.00, 1, '{}', 2),
(7, 'poleQ3', 1, 'something', 100.00, 1, '{}', 2),
(
    8,
    'gloveG4',
    1,
    ...
    100.00,
    1,
    '{\"size\":\"M\", \"brand\":\"fox\", \"width\":\"52\", \"skill_level\":\"DH\" }',
    16
  ),
(
    10,
...
VALUES
  (
    63,
    '868A09D4D61EC60F6DE75F09DCDFDD0F',
    '2021-05-02 15:43:07',
    1,
    1
  ),
(
    64,
    'CB67B42623A1D67195CF9D86C43AA3EF',
    '2021-05-02 15:53:17',
    1,
    1
  ),
(
    65,
    '4478461D6F30B3682F664E00BAE7988F',
    '2021-05-02 16:39:28',
    1,
    1
  ),
(
    66,
    'EDEF6DA6CACC59DCED967C868537A133',
    '2021-05-03 00:20:21',
    1,
    1
  ),
(
    67,
    '234F3E4D019A5198A0680CDD0F518A6E',
    '2021-05-03 02:13:15',
    1,
    1
  ),
(
    68,
    '2561ED95753271688D4A50CA025918C6',
    '2021-05-03 02:17:11',
    1,
    1
  );
...
INSERT INTO
  `users`
VALUES
  (1, 'user1', 'squizz', NULL, NULL, NULL, 1, 1),
(3, 'Randy', '0000', 170.00, 66.00, 42.0, 2, 1),
(4, 'Andrea', '0000', 169.00, 66.00, 37.0, 2, 1),
(5, 'Ruby', '0000', 168.00, 55.00, 41.0, 3, 1),
(6, 'Kiet', '0000', 167.00, 33.00, 44.0, 2, 1),
(7, 'Kai', '0000', 165.00, 78.00, 38.0, 3, 1);
...
-- Dump completed on 2021-05-09 23:07:11