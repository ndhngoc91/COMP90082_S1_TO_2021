...
CREATE TABLE `addresses` (
  ...
  `postcode` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `categories` (
  `id` int NOT NULL,
  `name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `image_url` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `customer_code` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `organization_desc` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nationality_code` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `extra` (
  ...
  `extracol` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`idextra`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_receipts` (
  ...
  `receipt` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `is_drop_ship` enum('Y','N') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'N',
  `is_pending` enum('Y','N') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'N',
...
CREATE TABLE `organizations` (
  `id` int NOT NULL AUTO_INCREMENT,
  `organization_id` varchar(80) COLLATE utf8mb4_general_ci NOT NULL,
  `api_organization_key` text COLLATE utf8mb4_general_ci,
  `api_organization_password` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_code` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `supplier_organization_id` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `package_ttypes_pair` (
  ...
  `sellcode` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `product_groups` (
  ...
  `description` varchar(80) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
...
CREATE TABLE `user_groups` (
  ...
  `users` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `first_name` varchar(127) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `last_name` varchar(127) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gender` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `birthdate` date DEFAULT NULL,
  `phone` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `skier_ablility` int DEFAULT NULL,
...
-- Dump completed on 2021-05-10 23:37:13
