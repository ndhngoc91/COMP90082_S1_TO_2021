describe("Test the address page", () => {
    ...
    it("Add address Page successfully", () => {
        ...
        cy.get("#postcode").type("3053").should("have.value", "3053");
        cy.get(".ant-form-item-control-input-content > .ant-btn").click();

        cy.get("body").should("contain", "48 Bouverie St");
    });

    it("Delete the address page successfully", () => {
        cy.get(".ant-menu").contains("Ruby").click();
        cy.get("#user\\$Menu").contains("Account").click();
    ...
    it("Edit the address page successfully", () => {
        cy.get(".ant-menu").contains("Ruby").click();
        cy.get("#user\\$Menu").contains("Account").click();
        ...
        cy.get("#postcode").clear().type("3053").should("have.value", "3053");
        cy.get(".ant-form-item-control-input-content > .ant-btn").click();
